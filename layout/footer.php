        ...
        <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
            <div class="md:flex md:justify-between mb-8">
                <div class="grid grid-cols-2 gap-8 sm:gap-10 sm:grid-cols-4">
                    ...
                    <div>
                        <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Politique de confidentialité</h2>
            ...
            <div class="sm:flex sm:items-center sm:justify-center">
                ...
                <div class="">
                    <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">Site créer par Damien DUBOST.
                </div>
            </div>
        </div>
    </footer>
